                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputName1" placeholder="Deskripsi" name="deskripsi" value="{{ $banner->deskripsi}}">
                      </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
                            <strong>Banner</strong>
                            <input type="hidden" name="oldImage1" value="{{ $banner->gambar }}">
                            @if ($banner->gambar)
