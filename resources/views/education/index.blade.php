                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($educations as $education)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $education->id }}" />
                          </td>
                            <td>
                              {{ $education->judul}}
                            </td>
                            <td>
                              {{ $education->tahun_awal}}
                            </td>
                            <td>
                              {{ $education->tahun_akhir}}
                            </td>
                            <td>
                            <form action="{{ route('education.destroy', $education->id) }}" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="{{ route('education.edit', $education->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
