                ...
                <div class="card-body">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                @if ($gallery->gambar)
                                    <img src="{{ asset('storage/' . $gallery->gambar) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                @else
                                    <img class="img-preview img-fluid mb-3">
                                @endif
                                <img class="img-preview img-fluid mb-3 col-sm-5">
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control" @error('image') is-invalid @enderror name="gambar" id="image" onchange="previewImage()" value="{{ asset('storage/' . $gallery->gambar) }}">
                                    @error('image')
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="kategori_gallery">
                              ...
                              <option value="{{$kategorigallery->kategori}}" @if ($kategorigallery->kategori == $gallery->kategori_gallery) selected @endif>{{$kategorigallery->kategori}}</option>
                              @endforeach
                          </select>                                   
                      </div>
