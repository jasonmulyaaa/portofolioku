...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="pageheader-content text-center">
                        <h2 style="color: white">{!! $pagetitle[0]->contact !!}</h2>
    ...
    <div class="map-address-section padding-tb section-bg">
        <div class="container">
            <div class="section-header text-center">
                <span class="subtitle">{!! $pagetitle[0]->judul_contact !!}</span>
                <h2 class="title">{!! $pagetitle[0]->subjudul_contact !!}</h2>
            </div>
                        ...
                        <div class="contact-wrapper">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-content">
                                    ...
                                    <a href="mailto:{!! $konfigurasi[0]->email !!}">{!! $konfigurasi[0]->email !!}</a>
                                </div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-thumb">
    ...
    <div class="contact-section padding-tb">
        <div class="container">
            <div class="section-header text-center">
                <span class="subtitle">{!! $pagetitle[0]->subjudul_form !!}</span>
                <h2 class="title">{!! $pagetitle[0]->judul_form !!}</h2>
            </div>
            <div class="section-wrapper">
                <form class="contact-form" action="{{ route('contact.store') }}"  method="POST" enctype="multipart/form-data">
                    @csrf
