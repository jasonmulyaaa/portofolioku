                  ...
                  <div class="table-responsive">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <tbody>
                        @foreach ($kategoritutorials as $kategoritutorial)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $kategoritutorial->id }}" />
                          </td>
                            <td>
                              {{ $kategoritutorial->kategori}}
                            </td>
                            <td>
                            <form action="{{ route('kategoritutorial.destroy', $kategoritutorial->id) }}" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="{{ route('kategoritutorial.edit', $kategoritutorial->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
                    ...
                    @endif
                <form action="{{ route('kategoritutorial.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
