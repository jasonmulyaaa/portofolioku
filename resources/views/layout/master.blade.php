      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><span class="text-black fw-bold"><span id="time"></span> {{ Auth::user()->nama }}<span></h1>
                <script>
              ...
              <h3 class="welcome-sub-text">Hasil CV Anda: 
                ...
                <a href="{{ route('cv.show_pengajar', $resume->slug) }}" target="__blank" style="text-decoration: none;">{!! $resume->nama !!}</a>
                @else
                <a href="{{ route('cv.show', $resume->slug) }}" target="__blank" style="text-decoration: none;">{!! $resume->nama !!}</a>
                @endif
              </h3>
              @endif
          </li>
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown ">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{ asset('storage/' . Auth::user()->foto) }}" alt="Profile image" onerror="this.onerror=null; this.src='../../assets/images/faces/face8.jpg'">
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{ asset('storage/' . Auth::user()->foto) }}" alt="Profile image" onerror="this.onerror=null; this.src='../../assets/images/faces/face8.jpg'" style="width: 40px; height: 40px; object-fit:cover;">
              ...
              <a href="{{ route('profile.index') }}" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account text-primary me-2"></i>Edit Profil</a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar  sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          @if (auth()->user()->role == 'User' || auth()->user()->role == 'Pengajar')

          <li class="nav-item nav-category">Resume</li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('resumee.index') }}">
              <i class="menu-icon mdi mdi mdi-file-document-box"></i>
              <span class="menu-title">Resume</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('sosial.index') }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('working.index') }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('testipengajar.index') }}">
              <i class="menu-icon mdi mdi mdi-book"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('kategoritutorial.index') }}">
              <i class="menu-icon mdi mdi mdi-file-document-box"></i>
              <span class="menu-title">Kategori</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('subkategoritutorial.index') }}">
              <i class="menu-icon mdi mdi mdi-file-document-box"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('kategoricourse.index') }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('partner.index') }}">
              <i class="menu-icon mdi mdi mdi-book-open"></i>
              <span class="menu-title">Media Partner</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('metamanagement.index') }}">
