                ...
                <div class="col-lg-12">
                  ...
                  <div class="mt-3">
                    ...
                    <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                      <div class="d-flex">
                        <img class="img-sm rounded-10" src="{{ asset('storage/' . $user->foto) }}" alt="profile" style="object-fit: cover;" onerror="this.onerror=null; this.src='../../assets/images/faces/icon.png'">
                        <div class="wrapper ms-3">
                          <p class="ms-1 mb-1 fw-bold">{!! $user->nama !!}</p>
                          <small class="text-muted mb-0">{!! $tutorialtoday !!}</small>
                        </div>
                      </div>
