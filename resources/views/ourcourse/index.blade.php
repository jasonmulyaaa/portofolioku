              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($ourcourses as $ourcourse)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $ourcourse->id }}" />
                          </td>
                          <td>
                            <div style="width: 100px;">
                              <img src="{{ asset('storage/' . $ourcourse->gambar) }}" alt="No Image" class="img-fluid mt-3">
                          </div>
                          </td>
                            <td>
                              {{ $ourcourse->judul}}
                            ...
                            <td>
                            <form action="{{ route('ourcourse.destroy', $ourcourse->id) }}" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="{{ route('ourcourse.edit', $ourcourse->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
                    ...
                    @endif
                <form action="{{ route('ourcourse.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                  ...
                                  <form class="forms-sample">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="kategori">
                                        ...
                                        <option value="{{$kategoricourse->kategori}}">{{$kategoricourse->kategori}}</option>
                                        @endforeach
                                    </select>                                   
                                </div>
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="pengajar">
                                    ...
                                    @endphp
                                    <option value="{{$pengajar->nama}}">{{$pengajar->nama}}</option>
                                    @endforeach
                                </select>                                   
                            </div>
                                <div class="form-group">
