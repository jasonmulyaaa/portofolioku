                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($partners as $partner)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $partner->id }}" />
                          </td>
                            <td>
                            <div style="width: 100px;">
                              <img src="{{ asset('storage/' . $partner->logo) }}" alt="No Image" class="img-fluid mt-3">
                          </div>
                            </td>
                            <td>
                              {{ $partner->judul}}
                            ...
                            <a class="btn rounded-pill btn-warning" href="{{ route('partner.edit', $partner->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="file" class="form-control" @error('image') is-invalid @enderror name="logo" id="image" onchange="previewImage()">
                                                    @error('image')
