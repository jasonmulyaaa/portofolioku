                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($skills as $skill)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $skill->id }}" />
                          </td>
                            <td>
                              {{ $skill->skill}}
                            </td>
                            ...
                            <a class="btn rounded-pill btn-warning" href="{{ route('skill.edit', $skill->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
                                ...
                                <div class="card-body">
                                  ...
                                  <form class="forms-sample">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Skill" name="skill" value="{{ old('skill') }}">
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputName1">Persen</label>
                                      <input type="number" class="form-control" id="exampleInputName1" placeholder="Persen" name="persen" value="{{ old('persen') }}">
                                    </div>
