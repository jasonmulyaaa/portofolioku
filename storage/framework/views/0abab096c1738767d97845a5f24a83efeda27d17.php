...
<div class="content-wrapper bg-white">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Partner Table</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($partner->id); ?>" />
                          </td>
                            <td>
                            <div style="width: 100px;">
                              <img src="<?php echo e(asset('storage/' . $partner->logo)); ?>" alt="No Image" class="img-fluid mt-3">
                          </div>
                            </td>
                            <td>
                              <?php echo e($partner->judul); ?>

                            </td>
                            <td>
                              <?php echo e($partner->link); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('partner.destroy', $partner->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('partner.edit', $partner->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
                      ...
                      <div class="pull-right">
                        <a href="#" class="btn btn-danger" id="deleteAllSelectedpartner" onclick="location.reload()">Delete Selected</a>
                    </div>
...
unset($__errorArgs, $__bag); ?> name="logo" id="image" onchange="previewImage()">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/partner/index.blade.php ENDPATH**/ ?>