    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar  sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('subkategoritutorial.index')); ?>">
              <i class="menu-icon mdi mdi mdi-file-document-box"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('kategorigallery.index')); ?>">
              <i class="menu-icon mdi mdi mdi-book-open"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('partner.index')); ?>">
              <i class="menu-icon mdi mdi mdi-book-open"></i>
...
<?php /**PATH C:\xampp\htdocs\Resume\resources\views/layout/master.blade.php ENDPATH**/ ?>