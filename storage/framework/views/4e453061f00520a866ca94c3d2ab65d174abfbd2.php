                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($service->id); ?>" />
                          </td>
                          <td>
                            <div style="width: 100px;">
                              <img src="<?php echo e(asset('storage/' . $service->gambar)); ?>" alt="No Image" class="img-fluid mt-3">
                          </div>
                          </td>
                            <td>
                              <?php echo e($service->judul); ?>

                            </td>
                            <td class="text-wrap">
                              <?php echo e($service->deskripsi); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('service.destroy', $service->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('service.edit', $service->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/service/index.blade.php ENDPATH**/ ?>