                  ...
                  <div class="table-responsive">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $subkategoritutorials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkategoritutorial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($subkategoritutorial->id); ?>" />
                          </td>
                          <td>
                            <div style="width: 100px;">
                              <img src="<?php echo e(asset('storage/' . $subkategoritutorial->gambar)); ?>" alt="No Image" class="img-fluid mt-3">
                          </div>
                          </td>
                            <td>
                              <?php echo e($subkategoritutorial->kategori); ?>
                            ...
                            ?>
                            <td>
                              <?php echo e($mainkategori->kategori); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('subkategoritutorial.destroy', $subkategoritutorial->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('subkategoritutorial.edit', $subkategoritutorial->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?>
                <form action="<?php echo e(route('subkategoritutorial.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/subkategoritutorial/index.blade.php ENDPATH**/ ?>