...
<div class="content-wrapper bg-white">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Kategori Tutorial Table</h4>
                  <div class="table-responsive">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $kategoritutorials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategoritutorial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($kategoritutorial->id); ?>" />
                          </td>
                            <td>
                              <?php echo e($kategoritutorial->kategori); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('kategoritutorial.destroy', $kategoritutorial->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('kategoritutorial.edit', $kategoritutorial->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
                      ...
                      <?php echo $kategoritutorials->links(); ?>
                    ...
                    <?php endif; ?>
                <form action="<?php echo e(route('kategoritutorial.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/kategoritutorial/index.blade.php ENDPATH**/ ?>