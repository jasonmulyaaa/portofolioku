                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $gallerys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($gallery->id); ?>" />
                          </td>
                            <td>
                            <div style="width: 100px;">
                              <img src="<?php echo e(asset('storage/' . $gallery->gambar)); ?>" alt="No Image" class="img-fluid mt-3">
                          </div>
                            </td>
                            <td>
                              <?php echo e($gallery->judul); ?>

                            </td>
                            <td>
                              <?php echo e($gallery->kategori_gallery); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('gallery.destroy', $gallery->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('gallery.edit', $gallery->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="kategori_gallery">
                                        ...
                                        <option value="<?php echo e($kategorigallery->kategori); ?>"><?php echo e($kategorigallery->kategori); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>                                   
                                </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/gallery/index.blade.php ENDPATH**/ ?>