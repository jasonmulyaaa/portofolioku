          ...
          <div class="col-lg-4 mx-auto">
            ...
            <form action="<?php echo e(route('authentication')); ?>" method="post">
              <?php echo csrf_field(); ?>
                ...
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"><?php echo e(__('Log in')); ?></button
                </div>
              </form>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\Resume\resources\views/panel/index.blade.php ENDPATH**/ ?>