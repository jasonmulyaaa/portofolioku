                  ...
                  <div class="table-responsive">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $kategoricourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategoricourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($kategoricourse->id); ?>" />
                          </td>
                            <td>
                              <?php echo e($kategoricourse->kategori); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('kategoricourse.destroy', $kategoricourse->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('kategoricourse.edit', $kategoricourse->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
                      ...
                      <?php echo $kategoricourses->links(); ?>
                    ...
                    <?php endif; ?>
                <form action="<?php echo e(route('kategoricourse.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/kategoricourse/index.blade.php ENDPATH**/ ?>