...
<div class="content-wrapper bg-white">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Education History Table</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="<?php echo e($education->id); ?>" />
                          </td>
                            <td>
                              <?php echo e($education->judul); ?>

                            </td>
                            <td>
                              <?php echo e($education->tahun_awal); ?>

                            </td>
                            <td>
                              <?php echo e($education->tahun_akhir); ?>

                            </td>
                            <td>
                            <form action="<?php echo e(route('education.destroy', $education->id)); ?>" method="POST">
  
                            <a class="btn rounded-pill btn-warning" href="<?php echo e(route('education.edit', $education->id)); ?>">Edit</a>
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/education/index.blade.php ENDPATH**/ ?>