    ...
    <div class="row">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          ...
          <form action="<?php echo e(route('resumee.store')); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?> name="pdf" id="image" onchange="previewImage()" >
                                <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                          ...
                          <input type="date" class="form-control" id="exampleInputName1" placeholder="Tanggal Lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputName1">Pekerjaan</label>
                          <input type="text" class="form-control" id="exampleInputName1" placeholder="Pekerjaan" name="pekerjaan" value="<?php echo e(old('pekerjaan')); ?>">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputName1">Email</label>
                          <input type="email" class="form-control" id="exampleInputName1" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>">
                      </div>
                      
                      
                          <div class="form-group">
                            <label for="exampleInputName1">About Me</label>
                            <textarea type="text" class="form-control" id="content" placeholder="About Me" name="about_me"><?php echo e(old('about_me')); ?></textarea>
                              <script>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="Alamat" name="alamat" value="<?php echo e(old('alamat')); ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputName1">No Telp (Contoh: 6282188905567)</label>
                          <input type="number" class="form-control" id="exampleInputName1" placeholder="+62123456789" name="no_telp" value="<?php echo e(old('no_telp')); ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Contact Map</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Contact Map" name="contact_map" value="<?php echo e(old('contact_map')); ?>">
                    </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive">
              ...
              <?php endif; ?>
          <form action="<?php echo e(route('resumee.update', $resume->id)); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <div class="form-group">
                            <strong>File PDF (Max: 2MB)</strong>
                            <input type="hidden" name="oldImage2" value="<?php echo e($resume->pdf); ?>">
                            <?php if($resume->pdf): ?>
                                <img src="<?php echo e(asset('storage/' . $resume->pdf)); ?>" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                            <?php else: ?>
                                <img class="img-preview img-fluid mb-3">
                            <?php endif; ?>
                            <img class="img-preview img-fluid mb-3 col-sm-5">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Resume\resources\views/resumee/index.blade.php ENDPATH**/ ?>